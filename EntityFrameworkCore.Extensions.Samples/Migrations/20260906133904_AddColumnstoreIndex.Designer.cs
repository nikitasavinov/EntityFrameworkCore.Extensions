...
namespace EntityFrameworkCore.Extensions.Samples.Migrations
{
    ...
    [Migration("20260906133904_AddColumnstoreIndex")]
    partial class AddColumnstoreIndex
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("EntityFrameworkCore.Extensions.Samples.Order", b =>
                {
                    ...
                    b.HasIndex("Created", "Amount")
                        .HasDatabaseName("NCCI_Orders_Reporting")
                        .HasFilter("[Amount] > 0")
                        .HasAnnotation("EntityFrameworkCore.Extensions:ColumnstoreIndex", true);
